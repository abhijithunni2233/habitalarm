      ...
      <ScrollView style={s.scroll} showsVerticalScrollIndicator={false} contentContainerStyle={{paddingBottom:60}}>
        <View style={s.sec}>
          ...
          <View style={s.inputWrap}>
            ...
            <TextInput style={s.input} value={name} onChangeText={setName} placeholder="e.g. Morning Run" placeholderTextColor={COLORS.textMuted} maxLength={40} autoFocus={!existing}/>
          </View>
        </View>
        <View style={s.sec}>
        ...
        <View style={s.sec}>
          ...
          {alarms.length===0&&<Text style={s.emptyHint}>No alarms yet.</Text>}
          {alarms.map((a,i)=>(
...
const s = StyleSheet.create({
  ...
  inputWrap:{flexDirection:'row',alignItems:'center',backgroundColor:COLORS.bgCard,borderRadius:RADIUS.md,borderWidth:1.5,borderColor:COLORS.border,paddingHorizontal:SPACING.md,...SHADOW.sm},
  ...
  alarmRow:{flexDirection:'row',alignItems:'center',gap:SPACING.sm,backgroundColor:COLORS.bgCard,borderRadius:RADIUS.md,padding:SPACING.md,marginTop:SPACING.sm,...SHADOW.sm},
  ...
  dayBtn:{flex:1,alignItems:'center',paddingVertical:SPACING.sm,backgroundColor:COLORS.bgCard,borderRadius:RADIUS.md,borderWidth:1.5,borderColor:COLORS.border},
  dayLabel:{fontSize:12,fontWeight:'800',color:COLORS.text},
  previewCard:{flexDirection:'row',alignItems:'center',borderRadius:RADIUS.xl,padding:SPACING.md,gap:SPACING.sm,...SHADOW.card},
