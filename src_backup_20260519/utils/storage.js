...
const KEYS = { HABITS:'habitalarm_habits', LOGS:'habitalarm_logs', MOOD:'habitalarm_mood', USER:'habitalarm_user', GOALS:'habitalarm_goals' };
...
export function getStreakCount(logs,habitId){
  ...
  for(let i=0;i<365;i++){
    ...
    if(logs[key]&&logs[key][habitId])streak++;else if(i>0)break;
  }
  return streak;
}
